...
open class RoundedLucaButton: DesignableButton {
	...
	override open var intrinsicContentSize: CGSize {
		...
		let desiredButtonSize = CGSize(width: labelSize.width + titleEdgeInsets.left + titleEdgeInsets.right + imageWidth, height: labelSize.height + titleEdgeInsets.top + titleEdgeInsets.bottom + imageHeight)
