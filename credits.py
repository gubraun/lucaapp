...
"""
    ...
    // based on PR: https://github.com/carloe/LicenseGenerator-iOS/pull/38
"""
...
def license_paths_from_dir(directory):
    ...
    for dir_path, _, file_names in os.walk(directory):
        file_names = (file_name for file_name in file_names if (file_name.startswith("LICENSE") or file_name=="License.txt"))
