...
extension UIAlertController {
    ...
    static func okAndCancelAlert(title: String, message: String, completed: @escaping(Bool) -> ()) -> UIAlertController {
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
    ...
    func yesActionAndNoAlert(action: @escaping() -> (), viewController: UIViewController) {
    ...
    func actionAndCancelAlert(actionText: String, action: @escaping() -> (), viewController: UIViewController) {
...
fileprivate class CustomAlertController: UIAlertController {
    public var onDismissBegin: (() -> (Void))? = nil
    public var onDismissEnd: (() -> (Void))? = nil
