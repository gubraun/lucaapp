...
class AlertViewControllerFactory {
    ...
    static func createDataAccessAlertViewController(accesses: [HealthDepartment: [(TraceInfo, Location)]], allAccessesPressed: @escaping () -> ()) -> DataAccessAlertViewController {
    ...
    static func createAlertViewController(title: String, message: String, firstButtonTitle: String, firstButtonAction: (() -> Void)? = nil) -> LucaAlertViewController {
        let alert = instantiateViewController(identifier: "LucaAlertViewController") as! LucaAlertViewController
