...
struct TicketIOCoronaTestClaims: TestClaims {
    var version: Int
    var name: String
    var time: Int
    var category: TicketIOCategory
    var result: TicketIOResult
    var lab: String
    var doctor: String
...
struct TicketIOCoronaTest: CoronaTest {
    var version: Int
    var name: String
    var time: Int
    var category: TicketIOCategory
    ...
    static func decodeTestCode(parse code: String) -> Single<CoronaTest> {
        Single.create { observer -> Disposable in
            do {
                ...
                let jwt = try JWT<TicketIOCoronaTestClaims>(jwtString: parameters, verifier: verifier)
    ...
    init(claims: TicketIOCoronaTestClaims, originalCode: String) {
...
enum TicketIOResult: String, Codable {
...
enum TicketIOCategory: String, Codable {
