...
struct DmCoronaTest: DefaultJWTTest {
    ...
    static func decodeTestCode(parse code: String) -> Single<CoronaTest> {
        Single.create { observer -> Disposable in
            do {
                ...
                let publicKeyPath = Bundle.main.url(forResource: "dm_jwtRS256", withExtension: "key.pub")!
                ...
                observer(.success(DmCoronaTest(claims: jwt.claims, originalCode: parameters)))
            } catch let error {
