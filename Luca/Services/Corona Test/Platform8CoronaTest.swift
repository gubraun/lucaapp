...
struct Platform8CoronaTest: DefaultJWTTest {
    ...
    static func decodeTestCode(parse code: String) -> Single<CoronaTest> {
        Single.create { observer -> Disposable in
            do {
                ...
                let publicKeyPath = Bundle.main.url(forResource: "platform8_jwtRS256", withExtension: "key.pub")!
                ...
                observer(.success(Platform8CoronaTest(claims: jwt.claims, originalCode: parameters)))
            } catch let error {
